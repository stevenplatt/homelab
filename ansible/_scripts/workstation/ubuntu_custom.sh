...
# apply visual tweaks to the Ubuntu UI
ui_updates(){
    ...
    settings set org.gnome.desktop.interface clock-show-weekday true
    ...
    # 'org.gnome.Terminal.desktop', 'com.visualstudio.code.desktop', 'virt-manager.desktop', 'com.discordapp.Discord.desktop', \
...
printf "(Step 3 of 6): Installing non-standard repository applications\n"

external_apps &>> installation.log

######### Purge preinstalled Ubuntu applications #########
printf "(Step 4 of 6): Purging preinstalled applications\n"

remove_apps &>> installation.log

######### Apple Ubuntu interface updates #########
printf "(Step 5 of 6): Updating UI preferences\n"
ui_updates &>> installation.log

######### Upgrade system and applications, then reboot #########
printf "(Step 6 of 6): Upgrading Ubuntu base distribution image\n"
